...
📝 **ʟᴀɴɢᴜᴀɢᴇ:** [ᴘʏᴛʜᴏɴ3](https://www.python.org)

📚 **ʟɪʙʀᴀʀʏ:** [Pyrogram](https://docs.pyrogram.org)

📡 **ʜᴏꜱᴛᴇᴅ ᴏɴ:** [koyeb](https://app.koyeb.com)

📢 **ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ:** [ᴍᴀꜱᴀʟᴀ ᴜɴɪᴠᴇʀꜱᴇ](https://t.me/MovieMasala_Update)
"""
	ABOUT_DEV_TEXT = f"""
...
★ ꜱᴇɴᴅ ᴍᴇ ᴀɴʏ ꜰɪʟᴇ 🗃️ ɪ ᴡɪʟʟ ɢɪᴠᴇ ʏᴏᴜ ᴘᴇʀᴍᴀɴᴇɴᴛ ꜱʜᴀʀᴇᴀʙʟᴇ ʟɪɴᴋ.ꜰᴏʀ ᴍᴏʀᴇ ᴅᴇᴛᴀɪʟꜱ ɢᴏ ᴛʜʀᴏᴜɢʜ ᴀʙᴏᴜᴛ ʙᴜᴛᴛᴏɴ 🔘...
